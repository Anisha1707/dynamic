                             ...
                             <div class="col-md-7">
                                 <div class="contact-img text-center px-md-5">
                                     <div class="title mb-3">
                                         <h3 class="text-left text-uppercase "><strong>Family Question</strong><?php echo ($mode=='add')?'<span class="ml-5 pl-5 text-info">50%</span>':''; ?></h3>  
                                     ...
                                     <form name="frm" id="frm" method="post" action="">
                                        <div class="step active">
                                            <h4><strong>Do you have a spouse?</strong></h4>
                                            <div class="row my-3 justify-content-center no-revert">
                                                <div class="col-md-4">
                                                    <button type="button" class="btn btn-primary" id="btnspouse">Yes</button>
                                                </div>
                                                <div class="col-md-4">
                                                    <button type="button" class="btn btn-primary next-step">No</button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="step">
...
<script type="text/javascript">
    ...
    $(function(){
        $('#btnspouse').click(function() {
            window.location.href = "<?php echo SITEURL; ?>spouse-information/";
        });
