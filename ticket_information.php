                                 ...
                                 <div class="contact-img text-center px-md-5">
                                     ...
                                     <form name="frm" id="frm" method="post" action="">
                                        ...
                                        <div class="form-group"> 
                                            ...
                                            <select name="issue_with" id="issue_with" class="form-control">
                                        ...
                                        <div class="form-group"> 
                                            <input type="text" name="other_text" id="other_text" value="" class="form-control" placeholder="Other Text" maxlength="100"> 
                                        </div>
                                        <div class="form-group"> 
                                            <label for="subject">Subject</label>
                                            <input type="text" name="subject" id="subject" value="" class="form-control" placeholder="Subject" maxlength="300"> 
                                        </div>
                                        <div class="form-group"> 
                                            <label for="description">Description</label>
                                            <textarea name="description" id="description" class="form-control" rows="5" placeholder="Describe your issue"></textarea>
                                        </div>
