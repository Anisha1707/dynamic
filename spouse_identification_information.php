<?php 
  include('connect.php'); 
  $db->checkLogin();
  // $_SESSION[SESS_PRE.'_TAX_APPLICATION_ID'] = 21;
  // $_SESSION[SESS_PRE.'_SPOUSE_ID'] = 10;
  //print_r($_SESSION);
  ...
  curl_setopt_array($curl, array(
    CURLOPT_URL => API_URL."TaxApplication/GetTaxApplicationSpouseIdentification".$querystring,
